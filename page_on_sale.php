...
<html lang="en-us">
	...
	<div class = "frame">
		...
		<div class = "bump_racing">
			...
			<img src="img/bump/banner_on_sale.png">
		...
		<!-- On sale Game 1-->	
			...
			<!-- On sale game 3-->
			<div class = "outer" id="pdx">
			
			<p id="title">Project Diva X</p>
				
				<div class = "wrap_left">
				
					<div id = "video">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/kCubA5uYqmA" frameborder="0" gesture="media" allowfullscreen></iframe>
					
										
					</div>
					<p>Hatsune Miku is back and bigger than ever on the PlayStation 4 and PlayStation Vita in the upcoming rhythm game, Hatsune Miku: Project DIVA X . For those new to Project DIVA, it is an addictive core rhythm game starring the digital singer, Hatsune Miku.
					...
					For the Miku veterans, Project DIVA X has 30 songs and 300 modules (costumes) that get dropped. </p>
				</div>
				...
				<div class = "wrap_right"> <!-- Right block-->
					<div id = "game_text">
						...
						<span style="text-decoration: line-through;font-size:1.6em;color:grey"> $59.00</span>
						<span style="font-size:1.6em;"> $29.99</span>
						<br/>Category: Rhythm Game<br/>Developer: Crypton Future Media<br/>
						Publisher: Sega<br/>
					...
					<div id = "game_img">
							<img src="img/games/game_other02.jpg">
							<div id = "clear"></div>
						...
						<form target="PayPal" action="https://www.paypal.com/cgi-bin/webscr" method="post" style="margin:0;padding:0;">
							...
							<input type="hidden" name="cmd" value="_cart">
							<input type="hidden" name="add" value="1">
							<input type="hidden" name="item_name" value="Project Diva X">
							<input type="hidden" name="item_number" value="ACO">
							<input type="hidden" name="amount" value="29.99">
							<input type="hidden" name="tax" value="3.96">
							<input type="hidden" name="currency_code" value="USD">
			...
			<div class = "outer" id="NOA">
			
			<p id="title">Nights of Azure</p>
			
				<div class = "wrap_left">
				
					<div id = "video">
						<iframe width="560" height="315" src="https://www.youtube.com/embed/aMUPw2EznYc" frameborder="0" gesture="media" allowfullscreen></iframe>
				
					</div>
					
					<p>Nights of Azure is a tragic tale of two friends faced with impossible decisions that will test their loyalty to their quest and to each other.
					Set on an uncharted island that floats in the North Sea, Nights of Azure paints a picture of a land where nights are tormented by azure-blooded demons.
					In this kingdom of Ruswal, very few people leave their homes after the sun has set, let alone have the strength and skill to take on these powerful monsters.</p>
				...
				<div class = "wrap_right"> <!-- Right block-->
					<div id = "game_text">
						...
						<br/>Category: RPG<br/>Developer: Gust Co. Ltd.<br/>
						Publisher: Koei Tecmo<br/>
						Release Date: Oct 1, 2015<br/>
						Platform: PS4, PS Vita, PS3, Microsoft Windows
						</p>
					</div>
					<div id = "game_img">
							<img src="img/games/game_other01.png">
							<div id = "clear"></div>
						...
						<div class ="platform_wrap">
							...
							<option value="PS4 Vita">PlayStation Vita</option>
			...
			<!-- On sale game 5-->	
			<div class = "outer" id="nfl17">
			
			<p id="title">NFL MADDEN 17</p>
			
				<div class = "wrap_left">
				
					<div id = "video">
						<iframe width="560" height="315" src="https://www.youtube.com/embed/VEmQEFCBp2c" frameborder="0" gesture="media" allowfullscreen></iframe>
				
					</div>
					
					<p>Madden NFL 17 is an American football sports video game based on the National Football League
					and published by EA Sports for the PlayStation 4, PlayStation 3, Xbox One and Xbox 360.</p>
				...
				<div class = "wrap_right"> <!-- Right block-->
					<div id = "game_text">
						...
						<span style="text-decoration: line-through;font-size:1.6em;color:grey"> $59.00</span>
						<span style="font-size:1.6em;"> $29.99</span>
						<br/>Category: Sports<br/>Developer: EA Tiburon<br/>
						Publisher: EA Sports<br/>
						Release Date: Aug 23, 2016<br/>
						Platform: PS4, PS3, Xbox One, Xbox 360
						</p>
					</div>
					<div id = "game_img">
							<img src="img/games/game_sports01.jpg">
							<div id = "clear"></div>
						...
						<form target="PayPal" action="https://www.paypal.com/cgi-bin/webscr" method="post" style="margin:0;padding:0;">
							...
							<input type="hidden" name="cmd" value="_cart">
							<input type="hidden" name="add" value="1">
							<input type="hidden" name="item_name" value="MADDEN17">
							<input type="hidden" name="item_number" value="ACO">
							<input type="hidden" name="amount" value="29.99">
							<input type="hidden" name="tax" value="3.96">
							<input type="hidden" name="currency_code" value="USD">
						...
						<div class ="platform_wrap">
							...
							<option value="Xbox One">Xbox 360</option>
							<option value="PC">Microsoft Windows</option>
				...
				<p id="title">Fatal Frame: Maiden of Black Water</p>
					...
					<div class = "wrap_right"> <!-- Right block-->
						...
						<span style="text-decoration: line-through;font-size:1.6em;color:grey"> $59.00</span>
						<span style="font-size:1.6em;"> $29.99</span>
						<br/>Category: Horror<br/>Developer: Koei Tecmo<br/>
						Publisher: Nintendo<br/>
						Release Date: Sep 27, 2014<br/>
						Platform: Nintendo Wii U
						</p>
						</div>
						<div id = "game_img">
							<img src="img/games/game_other0.png">
							<div id = "clear"></div>
						...
						<form target="PayPal" action="https://www.paypal.com/cgi-bin/webscr" method="post" style="margin:0;padding:0;">
							...
							<input type="hidden" name="cmd" value="_cart">
							<input type="hidden" name="add" value="1">
							<input type="hidden" name="item_name" value="Fatal Frame Maiden of Black Water">
							<input type="hidden" name="item_number" value="ACO">
							<input type="hidden" name="amount" value="29.99">
							<input type="hidden" name="tax" value="3.96">
							<input type="hidden" name="currency_code" value="USD">
						...
						<div class ="platform_wrap">
							...
							<option value="Wii U JP">Nintendo Wii U JP</option>
							<option value="Wii U NTSC">Nintendo Wii U NTSC</option>
			...
			<p id="title">NHL 18</p>
				...
				<div class = "wrap_left">
					...
					<div id = "video">
						<iframe width="560" height="315" src="https://www.youtube.com/embed/TcodG8Wi1Z0" frameborder="0" gesture="media" allowfullscreen></iframe>
				
					</div>
					
					<p>NHL 18 is an ice hockey simulation video game developed by EA Canada and published by EA Sports.
					It was released on Playstation 4 and Xbox One on September 15, 2017</p>
				...
				<div class = "wrap_right"> <!-- Right block-->
					<div id = "game_text">
						...
						75%off </span>
						<span style="text-decoration: line-through;font-size:1.6em;color:grey"> $59.00</span>
						<span style="font-size:1.6em;"> $14.99</span>
						<br/>Category: Sports<br/>Developer: EA Canada<br/>
						Publisher: EA Sports<br/>
						Release Date: Sep 15, 2017<br/>
						Platform: PS4, Xbox One
						</p>
					</div>
					<div id = "game_img">
							<img src="img/games/game_sports02.jpg">
							<div id = "clear"></div>
						...
						<form target="PayPal" action="https://www.paypal.com/cgi-bin/webscr" method="post" style="margin:0;padding:0;">
							...
							<input type="hidden" name="cmd" value="_cart">
							<input type="hidden" name="add" value="1">
							<input type="hidden" name="item_name" value="NHL18">
							<input type="hidden" name="item_number" value="ACO">
			...
			<!-- On sale game 8-->	
			<div class = "outer" id="rbi2017">
			
			<p id="title">RBI Baseball 2017</p>
			
				<div class = "wrap_left">
				
					<div id = "video">
						<iframe width="560" height="315" src="https://www.youtube.com/embed/SqrEUjA38Jo" frameborder="0" gesture="media" allowfullscreen></iframe>
				
					</div>
					
					<p>Get a head start on the MLB season with R.B.I. Baseball 2017 that just hit stores on Xbox One, PS4 and iOS. R.B.I.
					Baseball 2017 returns with fast paced, high-octane, pick-up-and-play baseball action.
					Take control of your game with reactive pitching and batting for in-the-moment decisions.
					R.B.I. 2017 is packed with 30 authentic ballparks, advanced</p>
				...
				<div class = "wrap_right"> <!-- Right block-->
					<div id = "game_text">
						...
						<span style="text-decoration: line-through;font-size:1.6em;color:grey"> $59.00</span>
						<span style="font-size:1.6em;"> $29.99</span>
						<br/>Category: Sports<br/>Developer: MLB<br/>
						Publisher: MLB<br/>
						Release Date: Sep 5, 2017<br/>
						Platform: PS4, Xbox one, iphone, ipad
						</p>
					</div>
					<div id = "game_img">
							<img src="img/games/game_sports03.png">
							<div id = "clear"></div>
						...
						<form target="PayPal" action="https://www.paypal.com/cgi-bin/webscr" method="post" style="margin:0;padding:0;">
							...
							<input type="hidden" name="cmd" value="_cart">
							<input type="hidden" name="add" value="1">
							<input type="hidden" name="item_name" value="RBI2017">
							<input type="hidden" name="item_number" value="ACO">
							<input type="hidden" name="amount" value="29.99">
							<input type="hidden" name="tax" value="3.96">
							<input type="hidden" name="currency_code" value="USD">
		...
		<!-- Advertising on sale games block -->	
			...
			<div id = "on_sale_advertise">
				...
				<p>Check out our featured games!</p>
		...
		<table>
			<tr>
				<th><a href="page_featured_games.php#codww2"><img src = "img/games/game_shooter02.jpg" alt = "ON_SALE"</a></th>
				<th><a href="page_featured_games.php#origins"><img src = "img/games/game_adventure01.jpg" alt = "ON_SALE"</a></th>
				<th><a href="page_featured_games.php#shadow_of_war"><img src = "img/games/game_adventure04.png" alt = "ON_SALE"</a></th>
				<th><a href="page_featured_games.php#forza_horizon3"><img src = "img/games/game_racing01.png" alt = "ON_SALE"</a></th>
				<th><a href="page_featured_games.php#nioh"><img src = "img/games/game_rpg02.jpg" alt = "ON_SALE"</a></th>
				<th><a href="page_featured_games.php#sm_odyssey"><img src = "img/games/game_adventure0.png" alt = "ON_SALE"</a></th>
				<th><a href="page_featured_games.php#TEW2"><img src = "img/games/game_other02.png" alt = "ON_SALE"</a></th>
			</tr>
		</table>
		</div>
...
<html lang="en-us">
	...
	<div class = "frame">
		...
		<table>
			<tr>
				<th><a href="page_featured_games.html#codww2"><img src = "img/games/game_shooter02.jpg" alt = "ON_SALE"</a></th>
				<th><a href="page_featured_games.html#origins"><img src = "img/games/game_adventure01.jpg" alt = "ON_SALE"</a></th>
				<th><a href="page_featured_games.html#shadow_of_war"><img src = "img/games/game_adventure04.png" alt = "ON_SALE"</a></th>
				<th><a href="page_featured_games.html#forza_horizon3"><img src = "img/games/game_racing01.png" alt = "ON_SALE"</a></th>
				<th><a href="page_featured_games.html#nioh"><img src = "img/games/game_rpg02.jpg" alt = "ON_SALE"</a></th>
				<th><a href="page_featured_games.html#sm_odyssey"><img src = "img/games/game_adventure0.png" alt = "ON_SALE"</a></th>
				<th><a href="page_featured_games.html#TEW2"><img src = "img/games/game_other02.png" alt = "ON_SALE"</a></th>
			</tr>
		</table>
		</div>
...
>>>>>>> 50d5de1c0db865ff9112b264f243e05a8e1125d9:page_on_sale.php
</html>