...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2019 at 04:29 PM
...
--
-- Database: `id12113437_gamegalaxy`
--
...
('athn3090', '761c627d8da27e02bc557e4921c1c17a');
...
INSERT INTO `users` (`name`, `username`, `email`, `password`, `mobile`, `address`, `id`) VALUES
('Aman Dev Chowdhary', 'athn', 'aman@gmail.com', 'e77989ed21758e78331b20e477fc5582', 9090909, 'b-226, haep, surat', 1),
('Tuneer', 'tuni', 'tuni@gmail.com', '190708ab57ece2f7cd2051ce3554f318', 75676767, 'bg-14, home sweet, home', 2);
...
ALTER TABLE `users`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `mobile number` (`mobile`);
